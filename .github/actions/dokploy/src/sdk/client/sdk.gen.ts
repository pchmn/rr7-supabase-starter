...
import type { AdminOneData, AdminOneError, AdminUpdateData, AdminUpdateError, AdminCreateUserInvitationData, AdminCreateUserInvitationError, AdminRemoveUserData, AdminRemoveUserError, AdminGetUserByTokenData, AdminGetUserByTokenError, AdminAssignPermissionsData, AdminAssignPermissionsError, DockerGetContainersData, DockerGetContainersError, DockerRestartContainerData, DockerRestartContainerError, DockerGetConfigData, DockerGetConfigError, DockerGetContainersByAppNameMatchData, DockerGetContainersByAppNameMatchError, DockerGetContainersByAppLabelData, DockerGetContainersByAppLabelError, AuthCreateAdminData, AuthCreateAdminError, AuthCreateUserData, AuthCreateUserError, AuthLoginData, AuthLoginError, AuthGetData, AuthGetError, AuthLogoutData, AuthLogoutError, AuthUpdateData, AuthUpdateError, AuthGenerateTokenData, AuthGenerateTokenError, AuthOneData, AuthOneError, AuthGenerate2FaSecretData, AuthGenerate2FaSecretError, AuthVerify2FaSetupData, AuthVerify2FaSetupError, AuthVerifyLogin2FaData, AuthVerifyLogin2FaError, AuthDisable2FaData, AuthDisable2FaError, AuthSendResetPasswordEmailData, AuthSendResetPasswordEmailError, AuthResetPasswordData, AuthResetPasswordError, AuthConfirmEmailData, AuthConfirmEmailError, ProjectCreateData, ProjectCreateError, ProjectOneData, ProjectOneError, ProjectAllData, ProjectAllError, ProjectRemoveData, ProjectRemoveError, ProjectUpdateData, ProjectUpdateError, ApplicationCreateData, ApplicationCreateError, ApplicationOneData, ApplicationOneError, ApplicationReloadData, ApplicationReloadError, ApplicationDeleteData, ApplicationDeleteError, ApplicationStopData, ApplicationStopError, ApplicationStartData, ApplicationStartError, ApplicationRedeployData, ApplicationRedeployError, ApplicationSaveEnvironmentData, ApplicationSaveEnvironmentError, ApplicationSaveBuildTypeData, ApplicationSaveBuildTypeError, ApplicationSaveGithubProviderData, ApplicationSaveGithubProviderError, ApplicationSaveGitlabProviderData, ApplicationSaveGitlabProviderError, ApplicationSaveBitbucketProviderData, ApplicationSaveBitbucketProviderError, ApplicationSaveDockerProviderData, ApplicationSaveDockerProviderError, ApplicationSaveGitProdiverData, ApplicationSaveGitProdiverError, ApplicationMarkRunningData, ApplicationMarkRunningError, ApplicationUpdateData, ApplicationUpdateError, ApplicationRefreshTokenData, ApplicationRefreshTokenError, ApplicationDeployData, ApplicationDeployError, ApplicationCleanQueuesData, ApplicationCleanQueuesError, ApplicationReadTraefikConfigData, ApplicationReadTraefikConfigError, ApplicationUpdateTraefikConfigData, ApplicationUpdateTraefikConfigError, ApplicationReadAppMonitoringData, ApplicationReadAppMonitoringError, MysqlCreateData, MysqlCreateError, MysqlOneData, MysqlOneError, MysqlStartData, MysqlStartError, MysqlStopData, MysqlStopError, MysqlSaveExternalPortData, MysqlSaveExternalPortError, MysqlDeployData, MysqlDeployError, MysqlChangeStatusData, MysqlChangeStatusError, MysqlReloadData, MysqlReloadError, MysqlRemoveData, MysqlRemoveError, MysqlSaveEnvironmentData, MysqlSaveEnvironmentError, MysqlUpdateData, MysqlUpdateError, PostgresCreateData, PostgresCreateError, PostgresOneData, PostgresOneError, PostgresStartData, PostgresStartError, PostgresStopData, PostgresStopError, PostgresSaveExternalPortData, PostgresSaveExternalPortError, PostgresDeployData, PostgresDeployError, PostgresChangeStatusData, PostgresChangeStatusError, PostgresRemoveData, PostgresRemoveError, PostgresSaveEnvironmentData, PostgresSaveEnvironmentError, PostgresReloadData, PostgresReloadError, PostgresUpdateData, PostgresUpdateError, RedisCreateData, RedisCreateError, RedisOneData, RedisOneError, RedisStartData, RedisStartError, RedisReloadData, RedisReloadError, RedisStopData, RedisStopError, RedisSaveExternalPortData, RedisSaveExternalPortError, RedisDeployData, RedisDeployError, RedisChangeStatusData, RedisChangeStatusError, RedisRemoveData, RedisRemoveError, RedisSaveEnvironmentData, RedisSaveEnvironmentError, RedisUpdateData, RedisUpdateError, MongoCreateData, MongoCreateError, MongoOneData, MongoOneError, MongoStartData, MongoStartError, MongoStopData, MongoStopError, MongoSaveExternalPortData, MongoSaveExternalPortError, MongoDeployData, MongoDeployError, MongoChangeStatusData, MongoChangeStatusError, MongoReloadData, MongoReloadError, MongoRemoveData, MongoRemoveError, MongoSaveEnvironmentData, MongoSaveEnvironmentError, MongoUpdateData, MongoUpdateError, MariadbCreateData, MariadbCreateError, MariadbOneData, MariadbOneError, MariadbStartData, MariadbStartError, MariadbStopData, MariadbStopError, MariadbSaveExternalPortData, MariadbSaveExternalPortError, MariadbDeployData, MariadbDeployError, MariadbChangeStatusData, MariadbChangeStatusError, MariadbRemoveData, MariadbRemoveError, MariadbSaveEnvironmentData, MariadbSaveEnvironmentError, MariadbReloadData, MariadbReloadError, MariadbUpdateData, MariadbUpdateError, ComposeCreateData, ComposeCreateError, ComposeOneData, ComposeOneError, ComposeUpdateData, ComposeUpdateError, ComposeDeleteData, ComposeDeleteError, ComposeCleanQueuesData, ComposeCleanQueuesError, ComposeLoadServicesData, ComposeLoadServicesError, ComposeFetchSourceTypeData, ComposeFetchSourceTypeError, ComposeRandomizeComposeData, ComposeRandomizeComposeError, ComposeGetConvertedComposeData, ComposeGetConvertedComposeError, ComposeDeployData, ComposeDeployError, ComposeRedeployData, ComposeRedeployError, ComposeStopData, ComposeStopError, ComposeGetDefaultCommandData, ComposeGetDefaultCommandError, ComposeRefreshTokenData, ComposeRefreshTokenError, ComposeDeployTemplateData, ComposeDeployTemplateError, ComposeTemplatesData, ComposeTemplatesError, ComposeGetTagsData, ComposeGetTagsError, UserAllData, UserAllError, UserByAuthIdData, UserByAuthIdError, UserByUserIdData, UserByUserIdError, DomainCreateData, DomainCreateError, DomainByApplicationIdData, DomainByApplicationIdError, DomainByComposeIdData, DomainByComposeIdError, DomainGenerateDomainData, DomainGenerateDomainError, DomainUpdateData, DomainUpdateError, DomainOneData, DomainOneError, DomainDeleteData, DomainDeleteError, DestinationCreateData, DestinationCreateError, DestinationTestConnectionData, DestinationTestConnectionError, DestinationOneData, DestinationOneError, DestinationAllData, DestinationAllError, DestinationRemoveData, DestinationRemoveError, DestinationUpdateData, DestinationUpdateError, BackupCreateData, BackupCreateError, BackupOneData, BackupOneError, BackupUpdateData, BackupUpdateError, BackupRemoveData, BackupRemoveError, BackupManualBackupPostgresData, BackupManualBackupPostgresError, BackupManualBackupMySqlData, BackupManualBackupMySqlError, BackupManualBackupMariadbData, BackupManualBackupMariadbError, BackupManualBackupMongoData, BackupManualBackupMongoError, DeploymentAllData, DeploymentAllError, DeploymentAllByComposeData, DeploymentAllByComposeError, DeploymentAllByServerData, DeploymentAllByServerError, MountsCreateData, MountsCreateError, MountsRemoveData, MountsRemoveError, MountsOneData, MountsOneError, MountsUpdateData, MountsUpdateError, CertificatesCreateData, CertificatesCreateError, CertificatesOneData, CertificatesOneError, CertificatesRemoveData, CertificatesRemoveError, CertificatesAllData, CertificatesAllError, SettingsReloadServerData, SettingsReloadServerError, SettingsReloadTraefikData, SettingsReloadTraefikError, SettingsToggleDashboardData, SettingsToggleDashboardError, SettingsCleanUnusedImagesData, SettingsCleanUnusedImagesError, SettingsCleanUnusedVolumesData, SettingsCleanUnusedVolumesError, SettingsCleanStoppedContainersData, SettingsCleanStoppedContainersError, SettingsCleanDockerBuilderData, SettingsCleanDockerBuilderError, SettingsCleanDockerPruneData, SettingsCleanDockerPruneError, SettingsCleanAllData, SettingsCleanAllError, SettingsCleanMonitoringData, SettingsCleanMonitoringError, SettingsSaveSshPrivateKeyData, SettingsSaveSshPrivateKeyError, SettingsAssignDomainServerData, SettingsAssignDomainServerError, SettingsCleanSshPrivateKeyData, SettingsCleanSshPrivateKeyError, SettingsUpdateDockerCleanupData, SettingsUpdateDockerCleanupError, SettingsReadTraefikConfigData, SettingsReadTraefikConfigError, SettingsUpdateTraefikConfigData, SettingsUpdateTraefikConfigError, SettingsReadWebServerTraefikConfigData, SettingsReadWebServerTraefikConfigError, SettingsUpdateWebServerTraefikConfigData, SettingsUpdateWebServerTraefikConfigError, SettingsReadMiddlewareTraefikConfigData, SettingsReadMiddlewareTraefikConfigError, SettingsUpdateMiddlewareTraefikConfigData, SettingsUpdateMiddlewareTraefikConfigError, SettingsCheckAndUpdateImageData, SettingsCheckAndUpdateImageError, SettingsUpdateServerData, SettingsUpdateServerError, SettingsGetDokployVersionData, SettingsGetDokployVersionError, SettingsReadDirectoriesData, SettingsReadDirectoriesError, SettingsUpdateTraefikFileData, SettingsUpdateTraefikFileError, SettingsReadTraefikFileData, SettingsReadTraefikFileError, SettingsGetIpData, SettingsGetIpError, SettingsGetOpenApiDocumentData, SettingsGetOpenApiDocumentError, SettingsReadTraefikEnvData, SettingsReadTraefikEnvError, SettingsWriteTraefikEnvData, SettingsWriteTraefikEnvError, SettingsHaveTraefikDashboardPortEnabledData, SettingsHaveTraefikDashboardPortEnabledError, SettingsReadStatsData, SettingsReadStatsError, SettingsGetLogRotateStatusData, SettingsGetLogRotateStatusError, SettingsToggleLogRotateData, SettingsToggleLogRotateError, SettingsHaveActivateRequestsData, SettingsHaveActivateRequestsError, SettingsToggleRequestsData, SettingsToggleRequestsError, SettingsIsCloudData, SettingsIsCloudError, SettingsHealthData, SettingsHealthError, SettingsSetupGpuData, SettingsSetupGpuError, SettingsCheckGpuStatusData, SettingsCheckGpuStatusError, SecurityCreateData, SecurityCreateError, SecurityOneData, SecurityOneError, SecurityDeleteData, SecurityDeleteError, SecurityUpdateData, SecurityUpdateError, RedirectsCreateData, RedirectsCreateError, RedirectsOneData, RedirectsOneError, RedirectsDeleteData, RedirectsDeleteError, RedirectsUpdateData, RedirectsUpdateError, PortCreateData, PortCreateError, PortOneData, PortOneError, PortDeleteData, PortDeleteError, PortUpdateData, PortUpdateError, RegistryCreateData, RegistryCreateError, RegistryRemoveData, RegistryRemoveError, RegistryUpdateData, RegistryUpdateError, RegistryAllData, RegistryAllError, RegistryOneData, RegistryOneError, RegistryTestRegistryData, RegistryTestRegistryError, ClusterGetNodesData, ClusterGetNodesError, ClusterRemoveWorkerData, ClusterRemoveWorkerError, ClusterAddWorkerData, ClusterAddWorkerError, ClusterAddManagerData, ClusterAddManagerError, NotificationCreateSlackData, NotificationCreateSlackError, NotificationUpdateSlackData, NotificationUpdateSlackError, NotificationTestSlackConnectionData, NotificationTestSlackConnectionError, NotificationCreateTelegramData, NotificationCreateTelegramError, NotificationUpdateTelegramData, NotificationUpdateTelegramError, NotificationTestTelegramConnectionData, NotificationTestTelegramConnectionError, NotificationCreateDiscordData, NotificationCreateDiscordError, NotificationUpdateDiscordData, NotificationUpdateDiscordError, NotificationTestDiscordConnectionData, NotificationTestDiscordConnectionError, NotificationCreateEmailData, NotificationCreateEmailError, NotificationUpdateEmailData, NotificationUpdateEmailError, NotificationTestEmailConnectionData, NotificationTestEmailConnectionError, NotificationRemoveData, NotificationRemoveError, NotificationOneData, NotificationOneError, NotificationAllData, NotificationAllError, SshKeyCreateData, SshKeyCreateError, SshKeyRemoveData, SshKeyRemoveError, SshKeyOneData, SshKeyOneError, SshKeyAllData, SshKeyAllError, SshKeyGenerateData, SshKeyGenerateError, SshKeyUpdateData, SshKeyUpdateError, GitProviderGetAllData, GitProviderGetAllError, GitProviderRemoveData, GitProviderRemoveError, BitbucketCreateData, BitbucketCreateError, BitbucketOneData, BitbucketOneError, BitbucketBitbucketProvidersData, BitbucketBitbucketProvidersError, BitbucketGetBitbucketRepositoriesData, BitbucketGetBitbucketRepositoriesError, BitbucketGetBitbucketBranchesData, BitbucketGetBitbucketBranchesError, BitbucketTestConnectionData, BitbucketTestConnectionError, BitbucketUpdateData, BitbucketUpdateError, GitlabCreateData, GitlabCreateError, GitlabOneData, GitlabOneError, GitlabGitlabProvidersData, GitlabGitlabProvidersError, GitlabGetGitlabRepositoriesData, GitlabGetGitlabRepositoriesError, GitlabGetGitlabBranchesData, GitlabGetGitlabBranchesError, GitlabTestConnectionData, GitlabTestConnectionError, GitlabUpdateData, GitlabUpdateError, GithubOneData, GithubOneError, GithubGetGithubRepositoriesData, GithubGetGithubRepositoriesError, GithubGetGithubBranchesData, GithubGetGithubBranchesError, GithubGithubProvidersData, GithubGithubProvidersError, GithubTestConnectionData, GithubTestConnectionError, GithubUpdateData, GithubUpdateError, ServerCreateData, ServerCreateError, ServerOneData, ServerOneError, ServerAllData, ServerAllError, ServerWithSshKeyData, ServerWithSshKeyError, ServerSetupData, ServerSetupError, ServerRemoveData, ServerRemoveError, ServerUpdateData, ServerUpdateError, ServerPublicIpData, ServerPublicIpError, StripeGetProductsData, StripeGetProductsError, StripeCreateCheckoutSessionData, StripeCreateCheckoutSessionError, StripeCreateCustomerPortalSessionData, StripeCreateCustomerPortalSessionError, StripeCanCreateMoreServersData, StripeCanCreateMoreServersError } from './types.gen';

export const client = createClient(createConfig());

export const adminOne = <ThrowOnError extends boolean = false>(options?: Options<AdminOneData, ThrowOnError>) => {
...
export const adminUpdate = <ThrowOnError extends boolean = false>(options: Options<AdminUpdateData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AdminUpdateError, ThrowOnError>({
        ...options,
        headers: {
...
export const adminCreateUserInvitation = <ThrowOnError extends boolean = false>(options: Options<AdminCreateUserInvitationData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AdminCreateUserInvitationError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const adminRemoveUser = <ThrowOnError extends boolean = false>(options: Options<AdminRemoveUserData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AdminRemoveUserError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const adminGetUserByToken = <ThrowOnError extends boolean = false>(options: Options<AdminGetUserByTokenData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, AdminGetUserByTokenError, ThrowOnError>({
        ...options,
        url: '/admin.getUserByToken'
    });
};

export const adminAssignPermissions = <ThrowOnError extends boolean = false>(options: Options<AdminAssignPermissionsData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AdminAssignPermissionsError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authCreateAdmin = <ThrowOnError extends boolean = false>(options: Options<AuthCreateAdminData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthCreateAdminError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authCreateUser = <ThrowOnError extends boolean = false>(options: Options<AuthCreateUserData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthCreateUserError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authLogin = <ThrowOnError extends boolean = false>(options: Options<AuthLoginData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthLoginError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authGet = <ThrowOnError extends boolean = false>(options?: Options<AuthGetData, ThrowOnError>) => {
...
export const authLogout = <ThrowOnError extends boolean = false>(options?: Options<AuthLogoutData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthLogoutError, ThrowOnError>({
        ...options,
        url: '/auth.logout'
    });
};

export const authUpdate = <ThrowOnError extends boolean = false>(options: Options<AuthUpdateData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthUpdateError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authGenerateToken = <ThrowOnError extends boolean = false>(options?: Options<AuthGenerateTokenData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthGenerateTokenError, ThrowOnError>({
        ...options,
        url: '/auth.generateToken'
    });
};

export const authOne = <ThrowOnError extends boolean = false>(options: Options<AuthOneData, ThrowOnError>) => {
...
export const authGenerate2FaSecret = <ThrowOnError extends boolean = false>(options?: Options<AuthGenerate2FaSecretData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, AuthGenerate2FaSecretError, ThrowOnError>({
        ...options,
        url: '/auth.generate2FASecret'
    });
};

export const authVerify2FaSetup = <ThrowOnError extends boolean = false>(options: Options<AuthVerify2FaSetupData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthVerify2FaSetupError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authVerifyLogin2Fa = <ThrowOnError extends boolean = false>(options: Options<AuthVerifyLogin2FaData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthVerifyLogin2FaError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authDisable2Fa = <ThrowOnError extends boolean = false>(options?: Options<AuthDisable2FaData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthDisable2FaError, ThrowOnError>({
        ...options,
        url: '/auth.disable2FA'
    });
};

export const authSendResetPasswordEmail = <ThrowOnError extends boolean = false>(options: Options<AuthSendResetPasswordEmailData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthSendResetPasswordEmailError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authResetPassword = <ThrowOnError extends boolean = false>(options: Options<AuthResetPasswordData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthResetPasswordError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const authConfirmEmail = <ThrowOnError extends boolean = false>(options: Options<AuthConfirmEmailData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, AuthConfirmEmailError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
...
export const userByAuthId = <ThrowOnError extends boolean = false>(options: Options<UserByAuthIdData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, UserByAuthIdError, ThrowOnError>({
        ...options,
        url: '/user.byAuthId'
    });
};

export const userByUserId = <ThrowOnError extends boolean = false>(options: Options<UserByUserIdData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, UserByUserIdError, ThrowOnError>({
        ...options,
        url: '/user.byUserId'
    });
};
...
export const settingsCheckAndUpdateImage = <ThrowOnError extends boolean = false>(options?: Options<SettingsCheckAndUpdateImageData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, SettingsCheckAndUpdateImageError, ThrowOnError>({
        ...options,
...
export const settingsReadStats = <ThrowOnError extends boolean = false>(options?: Options<SettingsReadStatsData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, SettingsReadStatsError, ThrowOnError>({
        ...options,
        url: '/settings.readStats'
    });
};

export const settingsGetLogRotateStatus = <ThrowOnError extends boolean = false>(options?: Options<SettingsGetLogRotateStatusData, ThrowOnError>) => {
    return (options?.client ?? client).get<unknown, SettingsGetLogRotateStatusError, ThrowOnError>({
        ...options,
        url: '/settings.getLogRotateStatus'
    });
};

export const settingsToggleLogRotate = <ThrowOnError extends boolean = false>(options: Options<SettingsToggleLogRotateData, ThrowOnError>) => {
    return (options?.client ?? client).post<unknown, SettingsToggleLogRotateError, ThrowOnError>({
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options?.headers
