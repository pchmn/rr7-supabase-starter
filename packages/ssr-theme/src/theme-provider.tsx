...
export type ThemeProviderProps = {
  ...
  themeAction:
    | string
    | ((opts: { data: { theme: Theme | null } }) => Promise<unknown>);
...
export function ThemeProvider({
  ...
  const [definedBy, setDefinedBy] = useState<'system' | 'user'>(
  ...
  }, [ensureCorrectTransition, definedBy]);
    ...
    (value) => {
      ...
      if (nextTheme === null) {
        ...
        ensureCorrectTransition(() => {
          ...
          setDefinedBy('system');
          broadcastThemeChange({ theme: preferredTheme });
        });
      } else {
        ensureCorrectTransition(() => {
          setTheme(nextTheme);
          setDefinedBy('user');
          broadcastThemeChange({ theme: nextTheme });
        });
      }
      ...
      if (typeof themeAction === 'string') {
        ...
        themeAction({ data: { theme: nextTheme } });
      }
    },
